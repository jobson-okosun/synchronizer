import{b as de,c as ue,d as u,e as he,g as C}from"./chunk-MVU443TA.js";import{c as ee,d as P,f as b,g as y,h as D}from"./chunk-36JN3LZY.js";import{I as ae,K as le,L as g,O as ce,R as pe,b as te,h as ie,j as oe,l as ne,q as E,t as re,u as se}from"./chunk-6OYVSFPU.js";import{c as U,d as X,e as G,g as J,h as v}from"./chunk-AA4OPQGJ.js";import{$a as d,Aa as z,Db as W,Fb as q,Gb as O,Ka as R,L as V,La as F,M as A,O as H,Oa as Z,Pa as M,Q as l,Qa as h,V as c,W as p,Wa as N,Wb as m,Xb as K,ab as T,bb as j,ha as _,jb as Q,nb as f,ob as r,pb as $,qb as Y,rb as S,ta as B,tb as x,ua as w,ub as L,za as k,zb as I}from"./chunk-SSBLKXZF.js";var ve=["content"],be=["*"],ye=(i,s)=>({showTransitionParams:i,hideTransitionParams:s}),ge=(i,s)=>({value:i,params:s}),Ce=i=>({closeCallback:i});function _e(i,s){}function we(i,s){i&1&&h(0,_e,0,0,"ng-template")}function ke(i,s){if(i&1){let e=Q();T(0,"div",1),f("click",function(o){c(e);let n=r();return p(n.onOverlayClick(o))})("@animation.start",function(o){c(e);let n=r();return p(n.onAnimationStart(o))})("@animation.done",function(o){c(e);let n=r();return p(n.onAnimationEnd(o))}),T(1,"div",2),f("click",function(o){c(e);let n=r();return p(n.onContentClick(o))})("mousedown",function(o){c(e);let n=r();return p(n.onContentClick(o))}),Y(2),h(3,we,1,0,null,3),j()()}if(i&2){let e=r();I(e.cn(e.cx("root"),e.styleClass)),d("pBind",e.ptm("root"))("ngStyle",e.style)("@animation",O(16,ge,e.overlayVisible?"open":"close",O(13,ye,e.showTransitionOptions,e.hideTransitionOptions))),N("aria-modal",e.overlayVisible)("aria-label",e.ariaLabel)("aria-labelledBy",e.ariaLabelledBy),w(),I(e.cx("content")),d("pBind",e.ptm("content")),w(2),d("ngTemplateOutlet",e.contentTemplate||e._contentTemplate)("ngTemplateOutletContext",q(19,Ce,e.onCloseClick.bind(e)))}}var Te=`
.p-popover {
